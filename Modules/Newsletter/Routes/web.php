...
Route::post('/subscribe', [NewsletterController::class, 'subscribe1'])->name('newsletter.subscribe');
Route::get('/subscribe/confirm/{token}', [NewsletterController::class, 'subscribeDataSave1'])->name('newsletter.subscribe.confirm');
