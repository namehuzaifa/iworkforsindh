...
@section('content')
    ...
    <div class="container mt-5 mb-5">
        <div class="form-container bg-white">
            ...
            <form action="{{ route('admin-skilled-labour.update', $labor->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="{{ route('admin-skilled-labour.index') }}" class="btn btn-secondary me-md-2">Cancel</a>
