                ...
                @foreach($courses as $course)
                    <tr>
                        ...
                        <td class="inline-block">
                            <button 
                                class="btn btn-info btn-sm view-course" 
                                ...
                                data-thumbnail="{{ asset($course->thumbnail_url) }}"
                            >
                                View Course
                            </button>
    ...
    <div class="modal fade" id="courseModal" tabindex="-1" aria-labelledby="courseModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4">
                        <img id="course-thumbnail" src="" alt="Course Image" class="img-fluid rounded">
                    </div>
                    <div class="col-md-8">
                        ...
                        <p><strong>Price:</strong> Rs <span id="course-price"></span></p>
...
<script>
    jQuery(document).ready(function() {
        ...
        $(document).on("click",".view-course",function() {
            ...
            // var course_price = $(this).data('discounted_price');
            var description = $(this).data('description');
            var thumbnail = $(this).data('thumbnail');

            $('#course-title').text(title);
            $('#course-category').text(category);
            $('#course-platform').text(platform);
            $('#course-price').text(price);
            // $('#course-price').text(course_price);
            $('#course-description').text(description);
            $('#course-thumbnail').attr('src', thumbnail);
        });
    });
</script>
@endsection