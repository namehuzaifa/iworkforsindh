...
<div class="main-body">
    ...
    <main class="container my-5">
        ...
        <div id="noCourses" class="text-center text-muted mb-5"
            style="{{ $courses->count() ? 'display:none' : '' }}">
...
@push('frontend_scripts')
    ...
    <script>
        function searchCourses() {
            ...
            let cards = document.querySelectorAll('.course-card-wrapper');
            let visible = 0;

            cards.forEach(card => {
                let title = card.querySelector('.card-title').innerText.toLowerCase();
                let cat = card.querySelector('.category-text').innerText.toLowerCase();

                let matchSearch = title.includes(input) || cat.includes(input);
        ...
        function filterByCategory() {
            searchCourses(); // Reuse same function
        }
    </script>
@endpush