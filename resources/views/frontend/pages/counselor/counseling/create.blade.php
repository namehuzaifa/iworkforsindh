...
@section('title', __('Create Counseling Session'))
                ...
                <div class="col-lg-9">
                    <div class="dashboard-right tw-ps-0 lg:tw-ps-5">
                        <div class="dashboard-right-header">
                            <div class="left-text">
                                <h5>{{ __('Create Counseling Session') }}</h5>
                                <p class="m-0">{{ __('Set up a new Zoom counseling session with available time slots') }}</p>
                            </div>
                            ...
                            <form action="{{ route('counselor.counseling.store') }}" method="POST">
                                ...
                                <div class="row tw-mb-4">
                                    ...
                                    <div class="col-md-6 tw-mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                               value="{{ old('title') }}" placeholder="e.g. Career Guidance Session" required>
                                        @error('title')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 tw-mb-3">
                                        ...
                                        <input type="number" name="fee" class="form-control @error('fee') is-invalid @enderror"
                                               value="{{ old('fee', 0) }}" min="0" step="1" placeholder="0 for free">
                                        @error('fee')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-12 tw-mb-3">
                                        ...
                                        <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                                  rows="3" placeholder="Describe what this counseling session covers...">{{ old('description') }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row tw-mb-4">
                                    ...
                                    <div class="col-md-6 tw-mb-3">
                                        ...
                                        <input type="text" name="zoom_meeting_id" class="form-control"
                                               value="{{ old('zoom_meeting_id') }}" placeholder="Optional">
                                    </div>
                                    <div class="col-md-6 tw-mb-3">
                                        ...
                                        <input type="text" name="zoom_passcode" class="form-control"
                                               value="{{ old('zoom_passcode') }}" placeholder="Optional">
                                    </div>
                                </div>
                                                ...
                                                <div class="tw-flex tw-items-center tw-flex-wrap tw-gap-3">
                                                    <div class="form-check tw-min-w-[120px]">
                                                        <input type="checkbox" name="days[]" value="{{ $dayNum }}"
                                                               ...
                                                               data-day="{{ $dayNum }}"
                                                               {{ in_array($dayNum, old('days', [])) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="tw-flex tw-items-center tw-gap-2 time-fields" id="time_fields_{{ $dayNum }}"
                                                         style="{{ in_array($dayNum, old('days', [])) ? '' : 'display:none' }}">
                                ...
                                <div class="tw-flex tw-gap-3">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ph-check-circle tw-mr-1"></i> {{ __('Create Session') }}
                                    </button>
